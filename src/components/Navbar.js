...
const Navbar = ({ children }) => {
  ...
  useEffect(() => {
    fetch(`${BASE_API}/profile-img/${user?.email}`, {
      method: "GET",
      headers: {
    ...
    <>
      ...
      {user?.email ? (
        <li className="dropdown  dropdown-end ">
          ...
          >
            <li>
              <NavLink to="/dashboard/my-profile" className="text-lg">
                Profile
              </NavLink>
            </li>
            {admin ? (
              ...
              <>
                <li>
                  <NavLink to="/dashboard/my-order" className="text-lg">
                    My Order
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/add-review" className="text-lg">
                    Add a Review
                  </NavLink>
                </li>
              </>
            ...
            {admin && (
              <>
                ...
                <li>
                  <NavLink to="/dashboard/add-product" className="text-lg">
                    Add Product
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/manage-order" className="text-lg">
                    Manage Order
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/manage-product" className="text-lg">
                    Manage Product
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/manage-reviews" className="text-lg">
                    Manage Reviews
                  </NavLink>
                </li>
              </>
        ...
        <div className="drawer-content flex flex-col ">
          <div className=" navbar bg-[#0b1623] text-white  px-5 sticky top-0 z-50">
            <div className="container mx-auto">
              <Link
                to="/"
                className="flex-1 text-2xl font-bold px-2 mx-2 text-white"
              >
                <img
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 overflow-y-auto w-80 bg-base-100">
            ...
            <li>
              <NavLink
                to="/portfolio"
                className="rounded-lg text-md font-bold "
              >
                My Portfolio
              </NavLink>
            </li>
            ...
            {user?.email ? (
              ...
              <li>
                <NavLink
                  to="/login"
                  className="rounded-lg text-md font-bold pt-3 mb-5"
                >
                  Login
                </NavLink>
              </li>
