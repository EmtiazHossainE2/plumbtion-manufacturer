      ...
      <div className="flex items-center justify-center">
        <div className="card  w-96 bg-base-100 shadow-xl">
          <div className="card-body items-center text-center">
            ...
            <p className="text-lg">
              Your review can be inspire us to work hard and hard .
            </p>
            <form onSubmit={handleReview} className="space-y-4 pt-8 ">
              ...
              <textarea
                rows={2}
                type="text"
                placeholder="Your Review Text (max 250)"
                name="des"
                className=" input-bordered w-full textarea max-w-md text-lg "
                required
              />
              <input
                type="submit"
                value="Review"
                className="btn btn-secondary text-white w-full max-w-md text-lg"
              />
            </form>
          </div>
        </div>
