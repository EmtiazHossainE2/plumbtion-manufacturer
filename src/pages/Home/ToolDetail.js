...
const ToolDetail = () => {
  ...
  const {
    ...
    fetch(`${BASE_API}/tool/${toolId}`).then((res) => res.json())
  );
    ...
    if (admin) {
      ...
      fetch(`${BASE_API}/order`, {
        ...
        .then((data) => {
          ...
          const url = `${BASE_API}/tool/${toolId}`;
      ...
      <div className="px-5 lg:px-20 py-8 lg:py-16">
        <div className="flex flex-col lg:flex-row justify-start items-center">
          <div className="flex-1">
            <div>
              <img
                className="lg:max-w-xl rounded-xl px-5"
                src={detail?.img}
                alt="service-man"
              />
            </div>
          ...
          <div className="flex-1 px-5">
            <div className="space-y-4">
              <h2 className="text-2xl pt-5 lg:mt-0 capitalize">
                Pipe Name : {detail?.name}
              </h2>
                ...
                <div className="card-body ">
                  {parseInt(detail?.available) < parseInt(detail?.minOrder) ? (
                    <input
                      type="submit"
                      disabled
                      value="We Dont't have Sufficient Pipe . Try another day"
                      className="btn btn-secondary text-white w-full max-w-md "
                    />
                  ) : (
                    <form
                      onSubmit={handleSubmit(onSubmit)}
                      className="pt-8 space-y-3 flex flex-col justify-center items-center"
                    >
                      ...
                      <div className="form-control w-full max-w-xs">
                        ...
                        <p className="text-red-500 flex justify-start py-2">
                          ...
                          {errors.quantity?.type === "min" &&
                            `Min order is ${detail.minOrder}`}
                          {errors.quantity?.type === "max" &&
                            `Max order is ${detail?.available}`}
                        </p>
                      </div>
                      <div className="form-control w-full max-w-xs ">
                        <textarea
                      ...
                      <input
                        ...
                        value="Submit"
                        className="btn btn-secondary text-white disabled:bg-[#b5b3b3] disabled:text-white disabled:cursor-not-allowed text-lg"
                      />
                    </form>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  <div className="card lg:max-w-sm mx-auto bg-base-100 shadow-xl">
                    <div className="card-body items-center text-center">
                      <img
                        src="https://i.ibb.co/KNwgyn2/2.png"
                        alt="sponsor 2"
                      />
                    </div>
                  </div>
                  <div className="card lg:max-w-sm mx-auto bg-base-100 shadow-xl">
                    <div className="card-body items-center text-center">
                      <img
                        src="https://i.ibb.co/M5hdN6F/5.png"
                        alt="sponsor 5"
                      />
                    </div>
                  </div>
                  <div className="card lg:max-w-sm mx-auto bg-base-100 shadow-xl">
                    <div className="card-body items-center text-center">
                      <img
                        src="https://i.ibb.co/0y2W5Bb/3.png"
                        alt="sponsor 3"
                      />
                    </div>
                  </div>
